enyo.kind({
    ...
    components:[
        {kind:"onyx.Groupbox", components:[
            {name:"header", kind:"onyx.GroupboxHeader", content:"Add a Person"},
            {kind:"onyx.InputDecorator", components:[
                {name:"name", kind:"onyx.Input", selectOnFocus:true, placeholder:"Name"}
            ]}
        ]},
        ...
        {name:"buttons", classes:"buttons", components:[
            ...
            {name:"deletePerson", kind:"onyx.Button", content:"Delete", classes:"onyx-negative", showing:false, ontap:"deletePerson"},
            {name:"cancel", kind:"onyx.Button", content:"Cancel", classes:"onyx-gray", ontap:"hide"}
        ]},
    ...
    save:function() {
        ...
        if(name) {
            ...
            this.$.model.savePerson(this.person, enyo.bind(this, "saved"));
    ...
    deletePerson:function() {
        this.enableButtons(false);
        this.$.model.removePerson(this.person, enyo.bind(this, "deleted"));
    },
