enyo.kind({
    ...
    components:[
        {kind:"onyx.Groupbox", components:[
            {kind:"onyx.GroupboxHeader", classes:"purchased-gifts-header", components:[
    ...
    itemsChanged:function() {
        ...
        this.$.totalAmount.setContent(cit.Util.calcTotal(this.items));
        this.$.itemList.setCount(this.items.length);
        this.$.itemList.resized();
    },
    refresh:function() {
        this.itemsChanged();
    },
    setupItem:function(source, event) {
        ...
        event.item.$.amount.setContent(cit.Util.formatCurrency(i.amount) || "$0.00");
    },
